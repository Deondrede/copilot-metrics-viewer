...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestURL, getQuery as getQuery$1, useSession, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/h3/dist/index.mjs';
import { readFileSync } from 'fs';
import { resolve } from 'path';
import { withQuery, joinURL, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/ufo/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/defu/dist/defu.mjs';
import { ofetch, FetchError, createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/ofetch/dist/node.mjs';
import { snakeCase, upperFirst } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/scule/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/devalue/index.js';
import destr from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/klona/dist/index.mjs';
import { createHooks } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/hookable/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/unenv/runtime/fetch/index.mjs';
import { ProxyAgent, setGlobalDispatcher } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/undici/index.js';
import { hash } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/node_modules/@unhead/shared/dist/index.mjs';
...
const _a34ojxQ4tg = (function(nitro) {
...
const _8gIaRDQQ1q = defineNitroPlugin((nitro) => {
...
const _7QY1P3VA4q = defineNitroPlugin((nitroApp) => {
...
const _inlineRuntimeConfig = {
  ...
  "session": {
    "name": "nuxt-session",
    "password": "39ae6b2267b24d7e9f7dd39c8fc8f819",
    "cookie": {
      "sameSite": "lax"
    },
    "maxAge": 21600
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\deond\\OneDrive\\Documents\\copilot-metrics-viewer","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\deond\\OneDrive\\Documents\\copilot-metrics-viewer\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\deond\\OneDrive\\Documents\\copilot-metrics-viewer\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\deond\\OneDrive\\Documents\\copilot-metrics-viewer\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\deond\\OneDrive\\Documents\\copilot-metrics-viewer\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
async function authenticateAndGetGitHubHeaders(event) {
  ...
  if (secure && secure.expires_at < new Date(Date.now() - 30 * 1e3)) {
    return buildHeaders("");
  }
  return buildHeaders((secure == null ? undefined : secure.tokens.access_token) || "");
}
...
const _zeo6Ad = defineEventHandler(async (event) => {
  const config = useRuntimeConfig(event);
...
const _Gz2kSF = defineEventHandler((event) => {
  console.log("Request: " + event.method + " " + getRequestURL(event));
});

const _gef4sg = eventHandler(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _htnaFC = eventHandler(async (event) => {
...
const _lazy_5z68cc = () => Promise.resolve().then(function () { return metrics$1; });
const _lazy_RzkZsX = () => Promise.resolve().then(function () { return seats$1; });
const _lazy_8wAtof = () => Promise.resolve().then(function () { return github_get$1; });
const _lazy_HNieqI = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _zeo6Ad, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _Gz2kSF, lazy: false, middleware: true, method: undefined },
  { route: '/api/metrics', handler: _lazy_5z68cc, lazy: true, middleware: false, method: undefined },
  { route: '/api/seats', handler: _lazy_RzkZsX, lazy: true, middleware: false, method: undefined },
  { route: '/auth/github', handler: _lazy_8wAtof, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_HNieqI, lazy: true, middleware: false, method: undefined },
  { route: '/api/_auth/session', handler: _gef4sg, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _htnaFC, lazy: false, middleware: false, method: "get" },
  { route: '/_fonts/**', handler: _lazy_HNieqI, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_HNieqI, lazy: true, middleware: false, method: undefined }
];
...
function ensureCopilotMetrics(data) {
  return data.map((item) => {
    ...
    (_a = item.copilot_ide_code_completions.editors) == null ? undefined : _a.forEach((editor) => {
      var _a2;
      (_a2 = editor.models) == null ? undefined : _a2.forEach((model) => {
        if (!model.languages) {
          model.languages = [];
        }
      });
...
const getClientManifest = () => import('file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/deond/OneDrive/Documents/copilot-metrics-viewer/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
