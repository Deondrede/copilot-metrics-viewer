...
var _fs = await jitiImport("fs"); // https://nuxt.com/docs/api/configuration/nuxt-config
const packageJson = (0, _fs.readFileSync)('package.json', 'utf8');
const version = JSON.parse(packageJson).version;var _default = exports.default =
